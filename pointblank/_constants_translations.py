EXPECT_FAIL_TEXT = {
    ...
    "str_len_expectation_text": {
        "en": "Expect that string lengths in {column_text} should be {values_text}.",
        "fr": "On s'attend à ce que les longueurs de chaîne dans {column_text} soient {values_text}.",
        "de": "Es wird erwartet, dass die Zeichenkettenlängen in {column_text} {values_text} sind.",
        "it": "Si aspetta che le lunghezze delle stringhe in {column_text} siano {values_text}.",
        "es": "Se espera que las longitudes de cadena en {column_text} sean {values_text}.",
        "pt": "Espera-se que os comprimentos de string em {column_text} sejam {values_text}.",
        "ro": "Se așteaptă ca lungimile șirului de caractere din {column_text} să fie {values_text}.",
        "tr": "Beklenti, {column_text} içindeki dize uzunluklarının {values_text} olmasıdır.",
        "zh-Hans": "预期{column_text}中的字符串长度应为{values_text}。",
        "zh-Hant": "{column_text}中的字串長度應為{values_text}。",
        "ja": "{column_text}の文字列長が{values_text}であることを期待します。",
        "ko": "{column_text}의 문자열 길이가 {values_text}이어야 합니다.",
        "vi": "Kỳ vọng độ dài chuỗi trong {column_text} phải là {values_text}.",
        "ru": "Ожидается, что длины строк в {column_text} должны быть {values_text}.",
        "cs": "Očekává se, že délky řetězců ve sloupci {column_text} budou {values_text}.",
        "pl": "Spodziewaj się, że długości ciągów znaków w {column_text} będą {values_text}.",
        "da": "Forvent at strenglængderne i {column_text} er {values_text}.",
        "sv": "Förvänta dig att stränglängderna i {column_text} ska vara {values_text}.",
        "nb": "Forvent at strenglengdene i {column_text} skal være {values_text}.",
        "nl": "Verwacht dat de tekenreekslengten in {column_text} {values_text} zijn.",
        "fi": "Odota, että merkkijonojen pituudet sarakkeessa {column_text} ovat {values_text}.",
        "is": "Væntir þess að lengd strengja í {column_text} sé {values_text}.",
        "ar": "توقع أن تكون أطوال السلاسل النصية في {column_text} {values_text}.",
        "hi": "अपेक्षा है कि {column_text} में स्ट्रिंग की लंबाई {values_text} होनी चाहिए।",
        "el": "Αναμένεται τα μήκη συμβολοσειρών στη στήλη {column_text} να είναι {values_text}.",
        "id": "Mengharapkan bahwa panjang string dalam {column_text} adalah {values_text}.",
        "uk": "Очікується, що довжини рядків у {column_text} повинні бути {values_text}.",
        "bg": "Очаква се дължините на низовете в {column_text} да бъдат {values_text}.",
        "hr": "Očekuje se da duljine nizova u {column_text} budu {values_text}.",
        "et": "Eeldatakse, et stringide pikkused veerus {column_text} peaksid olema {values_text}.",
        "hu": "Elvárás, hogy a {column_text} karakterlánc-hosszai {values_text} legyenek.",
        "ga": "Táthar ag súil go mbeadh faid na teaghránna i {column_text} {values_text}.",
        "lv": "Tiek sagaidīts, ka virkņu garumi {column_text} ir {values_text}.",
        "lt": "Tikimasi, kad eilučių ilgiai stulpelyje {column_text} turėtų būti {values_text}.",
        "mt": "Huwa mistenni li t-tul tal-kordi f'{column_text} ikun {values_text}.",
        "sk": "Očakáva sa, že dĺžky reťazcov v {column_text} budú {values_text}.",
        "sl": "Pričakuje se, da bodo dolžine nizov v {column_text} {values_text}.",
        "he": "צפוי שאורכי המחרוזות ב{column_text} יהיו {values_text}.",
        "th": "คาดหวังว่าความยาวของสตริงใน {column_text} จะเป็น {values_text}",
        "fa": "انتظار می‌رود که طول رشته‌ها در {column_text} برابر {values_text} باشد.",
    },
    "str_len_failure_text": {
        "en": "Exceedance of failed test units where string lengths in {column_text} should have been {values_text}.",
        "fr": "Dépassement des unités de test ayant échoué où les longueurs de chaîne dans {column_text} auraient dû être {values_text}.",
        "de": "Überschreitung fehlgeschlagener Testeinheiten, bei denen die Zeichenkettenlängen in {column_text} {values_text} hätten sein sollen.",
        "it": "Superamento delle unità di test non riuscite in cui le lunghezze delle stringhe in {column_text} avrebbero dovuto essere {values_text}.",
        "es": "Se superó el número de unidades de prueba fallidas en que las longitudes de cadena en {column_text} deberían haber sido {values_text}.",
        "pt": "Excedeu o número de unidades de teste com falha onde os comprimentos de string em {column_text} deveriam ter sido {values_text}.",
        "ro": "Depășirea unităților de test eșuate unde lungimile șirului de caractere din {column_text} ar fi trebuit să fie {values_text}.",
        "tr": "{column_text} içindeki dize uzunluklarının {values_text} olması gereken başarısız test birimlerinin aşılması.",
        "zh-Hans": "错误过多，其中{column_text}中的字符串长度应为{values_text}。",
        "zh-Hant": "錯誤過多，{column_text}中的字串長度應為{values_text}。",
        "ja": "{column_text}の文字列長が{values_text}であるべきテスト単位の失敗の超過。",
        "ko": "{column_text}의 문자열 길이가 {values_text}이었어야 했던 실패한 테스트 단위 초과.",
        "vi": "Vượt quá số đơn vị kiểm tra thất bại trong đó độ dài chuỗi trong {column_text} đáng lẽ phải là {values_text}.",
        "ru": "Превышение неудачных тестовых единиц, где длины строк в {column_text} должны были быть {values_text}.",
        "cs": "Překročení počtu neúspěšných testů, kde délky řetězců ve sloupci {column_text} měly být {values_text}.",
        "pl": "Wystapiło przekroczenie liczby jednostek testowych zakończonych niepowodzeniem, w przypadku których długości ciągów znaków w {column_text} powinny wynosić {values_text}.",
        "da": "Overskridelse af antallet af fejlslagne testenheder, hvor strenglængderne i {column_text} skulle have været {values_text}.",
        "sv": "Överskrider antalet misslyckade testenheter där stränglängderna i {column_text} borde ha varit {values_text}.",
        "nb": "Overskridelse av mislykkede testenheter hvor strenglengdene i {column_text} skulle ha vært {values_text}.",
        "nl": "Overschrijding van mislukte testeenheden waarbij de tekenreekslengten in {column_text} {values_text} hadden moeten zijn.",
        "fi": "Epäonnistuneiden testiyksikköjen ylitys, joissa merkkijonojen pituuksien sarakkeessa {column_text} olisi pitänyt olla {values_text}.",
        "is": "Of mörg misheppnuð próf þar sem lengd strengja í {column_text} hefðu átt að vera {values_text}.",
        "ar": "تجاوز وحدات الاختبار الفاشلة حيث كان يجب أن تكون أطوال السلاسل النصية في {column_text} {values_text}.",
        "hi": "{column_text} में स्ट्रिंग की लंबाई {values_text} होनी चाहिए थी, ऐसे असफल परीक्षण इकाइयों की अधिकता।",
        "el": "Υπέρβαση αποτυχημένων μονάδων δοκιμής όπου τα μήκη συμβολοσειρών στη στήλη {column_text} θα έπρεπε να είναι {values_text}.",
        "id": "Melebihi unit pengujian yang gagal di mana panjang string dalam {column_text} seharusnya {values_text}.",
        "uk": "Перевищення невдалих тестових одиниць, де довжини рядків у {column_text} мали бути {values_text}.",
        "bg": "Надвишаване на неуспешни тестови единици, при които дължините на низовете в {column_text} са трябвало да бъдат {values_text}.",
        "hr": "Prekoračenje neuspjelih testnih jedinica gdje su duljine nizova u {column_text} trebale biti {values_text}.",
        "et": "Nurjunud testüksuste ületamine, kus stringide pikkused veerus {column_text} oleksid pidanud olema {values_text}.",
        "hu": "Sikertelen tesztegységek túllépése, ahol a {column_text} karakterlánc-hosszainak {values_text} kellett volna lennie.",
        "ga": "Sárú ar aonaid tástála theipthe ina raibh faid na teaghránna i {column_text} ba cheart a bheith {values_text}.",
        "lv": "Neizdevušos testa vienību pārsniegšana, kur virkņu garumiem {column_text} vajadzēja būt {values_text}.",
        "lt": "Viršytos nesėkmingos testo vienetų, kuriuose eilučių ilgiai stulpelyje {column_text} turėjo būti {values_text}.",
        "mt": "Eċċess ta' unitajiet tat-test li fallew fejn it-tul tal-kordi f'{column_text} kellu jkun {values_text}.",
        "sk": "Prekročenie neúspešných testovacích jednotiek, kde dĺžky reťazcov v {column_text} mali byť {values_text}.",
        "sl": "Prekoračitev neuspelih testnih enot, kjer bi morale dolžine nizov v {column_text} biti {values_text}.",
        "he": "חריגה של יחידות בדיקה כושלות שבהן אורכי המחרוזות ב{column_text} היו צריכים להיות {values_text}.",
        "th": "เกินหน่วยการทดสอบที่ล้มเหลวซึ่งความยาวของสตริงใน {column_text} ควรเป็น {values_text}",
        "fa": "تجاوز واحدهای آزمون ناموفق که در آن طول رشته‌ها در {column_text} باید {values_text} می‌بود.",
    },
}
...
NOTES_TEXT = {
    ...
    "active_check_step_skipped": {
        "en": "Step skipped",
        "fr": "Étape ignorée",
        "de": "Schritt übersprungen",
        "it": "Passaggio saltato",
        "es": "Paso omitido",
        "pt": "Etapa ignorada",
        "ro": "Pas omis",
        "tr": "Adım atlandı",
        ...
        "ja": "ステップがスキップされました",
        "ko": "단계 건너뜀",
        "vi": "Bước đã bị bỏ qua",
        "ru": "Шаг пропущен",
        "cs": "Krok přeskočen",
        "pl": "Krok pominięty",
        "da": "Trin sprunget over",
        "sv": "Steg hoppades över",
        "nb": "Trinn hoppet over",
        "nl": "Stap overgeslagen",
        "fi": "Vaihe ohitettu",
        "is": "Skref sleppt yfir",
        "ar": "تم تخطي الخطوة",
        "hi": "चरण छोड़ा गया",
        "el": "Το βήμα παραλείφθηκε",
        "id": "Langkah dilewati",
        "uk": "Крок пропущено",
        "bg": "Стъпката е пропусната",
        "hr": "Korak preskočen",
        "et": "Samm vahele jäetud",
        "hu": "Lépés kihagyva",
        "ga": "Céim scipeáilte",
        "lv": "Solis izlaists",
        "lt": "Žingsnis praleistas",
        "mt": "Pass maqbuż",
        "sk": "Krok preskočený",
        "sl": "Korak preskočen",
        "he": "השלב דולג",
    ...
    "active_check_missing_columns": {
        "en": "Column check failed: missing column(s) {columns}.",
        "fr": "Vérification des colonnes échouée : colonne(s) manquante(s) {columns}.",
        "de": "Spaltenprüfung fehlgeschlagen: fehlende Spalte(n) {columns}.",
        "it": "Controllo colonne fallito: colonna/e mancante/i {columns}.",
        "es": "Verificación de columnas fallida: columna(s) faltante(s) {columns}.",
        "pt": "Verificação de colunas falhou: coluna(s) ausente(s) {columns}.",
        "ro": "Verificare coloane eșuată: coloană/e lipsă {columns}.",
        "tr": "Sütun kontrolü başarısız: eksik sütun(lar) {columns}.",
        "zh-Hans": "列检查失败：缺少列 {columns}。",
        "zh-Hant": "列檢查失敗：缺少列 {columns}。",
        "ja": "列チェック失敗: 欠落している列 {columns}。",
        "ko": "열 확인 실패: 누락된 열 {columns}.",
        "vi": "Kiểm tra cột thất bại: cột bị thiếu {columns}.",
        "ru": "Проверка столбцов не пройдена: отсутствующие столбцы {columns}.",
        "cs": "Kontrola sloupců selhala: chybějící sloupec/sloupce {columns}.",
        "pl": "Sprawdzenie kolumn nie powiodło się: brakujące kolumny {columns}.",
        "da": "Kolonnekontrol mislykkedes: manglende kolonne(r) {columns}.",
        "sv": "Kolumnkontroll misslyckades: saknade kolumn(er) {columns}.",
        "nb": "Kolonnekontroll mislyktes: manglende kolonne(r) {columns}.",
        "nl": "Kolomcontrole mislukt: ontbrekende kolom(men) {columns}.",
        "fi": "Saraketarkistus epäonnistui: puuttuvat sarakkeet {columns}.",
        "is": "Dálkaathugun mistókst: vantar dálk(a) {columns}.",
        "ar": "فشل فحص الأعمدة: أعمدة مفقودة {columns}.",
        "hi": "स्तंभ जाँच विफल: अनुपलब्ध स्तंभ {columns}।",
        "el": "Ο έλεγχος στηλών απέτυχε: λείπουν στήλες {columns}.",
        "id": "Pemeriksaan kolom gagal: kolom yang hilang {columns}.",
        "uk": "Перевірка стовпців не пройдена: відсутні стовпці {columns}.",
        "bg": "Проверката на колони е неуспешна: липсващи колони {columns}.",
        "hr": "Provjera stupaca neuspješna: nedostajući stupac/stupci {columns}.",
        "et": "Veerukontroll ebaõnnestus: puuduvad veerud {columns}.",
        "hu": "Oszlopellenőrzés sikertelen: hiányzó oszlop(ok) {columns}.",
        "ga": "Theip ar sheiceáil colúin: colúin ar iarraidh {columns}.",
        "lv": "Kolonnu pārbaude neizdevās: trūkstošās kolonnas {columns}.",
        "lt": "Stulpelių tikrinimas nepavyko: trūkstami stulpeliai {columns}.",
        "mt": "Verifika tal-kolonni falliet: kolonni nieqsa {columns}.",
        "sk": "Kontrola stĺpcov zlyhala: chýbajúce stĺpce {columns}.",
        "sl": "Preverjanje stolpcev neuspešno: manjkajoči stolpci {columns}.",
        "he": "בדיקת עמודות נכשלה: עמודות חסרות {columns}.",
        "th": "การตรวจสอบคอลัมน์ล้มเหลว: คอลัมน์ที่หายไป {columns}",
        "fa": "بررسی ستون ناموفق: ستون‌های گمشده {columns}.",
    },
    "active_check_row_count_exact": {
        "en": "Row count check failed: expected exactly {expected} row(s), found {found}.",
        "fr": "Vérification du nombre de lignes échouée : attendu exactement {expected} ligne(s), trouvé {found}.",
        "de": "Zeilenanzahlprüfung fehlgeschlagen: genau {expected} Zeile(n) erwartet, {found} gefunden.",
        "it": "Controllo conteggio righe fallito: previste esattamente {expected} riga/e, trovate {found}.",
        "es": "Verificación del número de filas fallida: se esperaban exactamente {expected} fila(s), se encontraron {found}.",
        "pt": "Verificação de contagem de linhas falhou: esperadas exatamente {expected} linha(s), encontradas {found}.",
        "ro": "Verificare număr rânduri eșuată: așteptate exact {expected} rând(uri), găsite {found}.",
        "tr": "Satır sayısı kontrolü başarısız: tam olarak {expected} satır bekleniyordu, {found} bulundu.",
        "zh-Hans": "行数检查失败：预期正好 {expected} 行，实际 {found} 行。",
        "zh-Hant": "行數檢查失敗：預期正好 {expected} 行，實際 {found} 行。",
        "ja": "行数チェック失敗: 正確に {expected} 行を期待しましたが、{found} 行でした。",
        "ko": "행 수 확인 실패: 정확히 {expected}행이 예상되었으나 {found}행이 발견됨.",
        "vi": "Kiểm tra số hàng thất bại: mong đợi chính xác {expected} hàng, tìm thấy {found}.",
        "ru": "Проверка количества строк не пройдена: ожидалось ровно {expected} строк(и), найдено {found}.",
        "cs": "Kontrola počtu řádků selhala: očekáváno přesně {expected} řádků, nalezeno {found}.",
        "pl": "Sprawdzenie liczby wierszy nie powiodło się: oczekiwano dokładnie {expected} wiersz(y), znaleziono {found}.",
        "da": "Rækketællingskontrol mislykkedes: forventet nøjagtigt {expected} række(r), fandt {found}.",
        "sv": "Radräkningskontroll misslyckades: förväntade exakt {expected} rad(er), hittade {found}.",
        "nb": "Radtellingskontroll mislyktes: forventet nøyaktig {expected} rad(er), fant {found}.",
        "nl": "Rijtellingscontrole mislukt: precies {expected} rij(en) verwacht, {found} gevonden.",
        "fi": "Rivimäärätarkistus epäonnistui: odotettiin tasan {expected} riviä, löytyi {found}.",
        "is": "Raðfjöldaathugun mistókst: átti von á nákvæmlega {expected} röð(um), fannst {found}.",
        "ar": "فشل فحص عدد الصفوف: متوقع بالضبط {expected} صف(وف)، وجد {found}.",
        "hi": "पंक्ति गणना जाँच विफल: ठीक {expected} पंक्ति(यों) अपेक्षित, {found} पाई गईं।",
        "el": "Ο έλεγχος αριθμού γραμμών απέτυχε: αναμένονταν ακριβώς {expected} γραμμές, βρέθηκαν {found}.",
        "id": "Pemeriksaan jumlah baris gagal: diharapkan tepat {expected} baris, ditemukan {found}.",
        "uk": "Перевірка кількості рядків не пройдена: очікувалося рівно {expected} рядків, знайдено {found}.",
        "bg": "Проверката на брой редове е неуспешна: очаквани точно {expected} реда, намерени {found}.",
        "hr": "Provjera broja redaka neuspješna: očekivano točno {expected} redak(a), pronađeno {found}.",
        "et": "Reakontroll ebaõnnestus: oodati täpselt {expected} rida, leiti {found}.",
        "hu": "Sorellenőrzés sikertelen: pontosan {expected} sor volt várható, {found} található.",
        "ga": "Theip ar sheiceáil comhaireamh sraitheanna: ag súil le díreach {expected} sraith(eanna), aimsíodh {found}.",
        "lv": "Rindu skaita pārbaude neizdevās: gaidītas tieši {expected} rindas, atrastas {found}.",
        "lt": "Eilučių skaičiaus tikrinimas nepavyko: tikėtasi tiksliai {expected} eilučių, rasta {found}.",
        "mt": "Verifika tan-numru ta' ringiela falliet: mistenni eżatt {expected} ringiel(a), instab {found}.",
        "sk": "Kontrola počtu riadkov zlyhala: očakávalo sa presne {expected} riadkov, nájdených {found}.",
        "sl": "Preverjanje števila vrstic neuspešno: pričakovano natančno {expected} vrstic, najdenih {found}.",
        "he": "בדיקת מספר שורות נכשלה: צפויות בדיוק {expected} שורות, נמצאו {found}.",
        "th": "การตรวจสอบจำนวนแถวล้มเหลว: คาดหวังพอดี {expected} แถว พบ {found}",
        "fa": "بررسی تعداد ردیف ناموفق: دقیقاً {expected} ردیف انتظار می‌رفت، {found} یافت شد.",
    },
    "active_check_row_count_min": {
        "en": "Row count check failed: expected at least {min} row(s), found {found}.",
        "fr": "Vérification du nombre de lignes échouée : attendu au moins {min} ligne(s), trouvé {found}.",
        "de": "Zeilenanzahlprüfung fehlgeschlagen: mindestens {min} Zeile(n) erwartet, {found} gefunden.",
        "it": "Controllo conteggio righe fallito: previste almeno {min} riga/e, trovate {found}.",
        "es": "Verificación del número de filas fallida: se esperaban al menos {min} fila(s), se encontraron {found}.",
        "pt": "Verificação de contagem de linhas falhou: esperadas pelo menos {min} linha(s), encontradas {found}.",
        "ro": "Verificare număr rânduri eșuată: așteptate cel puțin {min} rând(uri), găsite {found}.",
        "tr": "Satır sayısı kontrolü başarısız: en az {min} satır bekleniyordu, {found} bulundu.",
        "zh-Hans": "行数检查失败：预期至少 {min} 行，实际 {found} 行。",
        "zh-Hant": "行數檢查失敗：預期至少 {min} 行，實際 {found} 行。",
        "ja": "行数チェック失敗: 少なくとも {min} 行を期待しましたが、{found} 行でした。",
        "ko": "행 수 확인 실패: 최소 {min}행이 예상되었으나 {found}행이 발견됨.",
        "vi": "Kiểm tra số hàng thất bại: mong đợi ít nhất {min} hàng, tìm thấy {found}.",
        "ru": "Проверка количества строк не пройдена: ожидалось не менее {min} строк(и), найдено {found}.",
        "cs": "Kontrola počtu řádků selhala: očekáváno alespoň {min} řádků, nalezeno {found}.",
        "pl": "Sprawdzenie liczby wierszy nie powiodło się: oczekiwano co najmniej {min} wiersz(y), znaleziono {found}.",
        "da": "Rækketællingskontrol mislykkedes: forventet mindst {min} række(r), fandt {found}.",
        "sv": "Radräkningskontroll misslyckades: förväntade minst {min} rad(er), hittade {found}.",
        "nb": "Radtellingskontroll mislyktes: forventet minst {min} rad(er), fant {found}.",
        "nl": "Rijtellingscontrole mislukt: minstens {min} rij(en) verwacht, {found} gevonden.",
        "fi": "Rivimäärätarkistus epäonnistui: odotettiin vähintään {min} riviä, löytyi {found}.",
        "is": "Raðfjöldaathugun mistókst: átti von á að minnsta kosti {min} röð(um), fannst {found}.",
        "ar": "فشل فحص عدد الصفوف: متوقع على الأقل {min} صف(وف)، وجد {found}.",
        "hi": "पंक्ति गणना जाँच विफल: कम से कम {min} पंक्ति(यों) अपेक्षित, {found} पाई गईं।",
        "el": "Ο έλεγχος αριθμού γραμμών απέτυχε: αναμένονταν τουλάχιστον {min} γραμμές, βρέθηκαν {found}.",
        "id": "Pemeriksaan jumlah baris gagal: diharapkan setidaknya {min} baris, ditemukan {found}.",
        "uk": "Перевірка кількості рядків не пройдена: очікувалося щонайменше {min} рядків, знайдено {found}.",
        "bg": "Проверката на брой редове е неуспешна: очаквани поне {min} реда, намерени {found}.",
        "hr": "Provjera broja redaka neuspješna: očekivano najmanje {min} redak(a), pronađeno {found}.",
        "et": "Reakontroll ebaõnnestus: oodati vähemalt {min} rida, leiti {found}.",
        "hu": "Sorellenőrzés sikertelen: legalább {min} sor volt várható, {found} található.",
        "ga": "Theip ar sheiceáil comhaireamh sraitheanna: ag súil le {min} sraith(eanna) ar a laghad, aimsíodh {found}.",
        "lv": "Rindu skaita pārbaude neizdevās: gaidītas vismaz {min} rindas, atrastas {found}.",
        "lt": "Eilučių skaičiaus tikrinimas nepavyko: tikėtasi bent {min} eilučių, rasta {found}.",
        "mt": "Verifika tan-numru ta' ringiela falliet: mistenni mill-inqas {min} ringiel(a), instab {found}.",
        "sk": "Kontrola počtu riadkov zlyhala: očakávalo sa aspoň {min} riadkov, nájdených {found}.",
        "sl": "Preverjanje števila vrstic neuspešno: pričakovano vsaj {min} vrstic, najdenih {found}.",
        "he": "בדיקת מספר שורות נכשלה: צפויות לפחות {min} שורות, נמצאו {found}.",
        "th": "การตรวจสอบจำนวนแถวล้มเหลว: คาดหวังอย่างน้อย {min} แถว พบ {found}",
        "fa": "بررسی تعداد ردیف ناموفق: حداقل {min} ردیف انتظار می‌رفت، {found} یافت شد.",
    },
    "active_check_row_count_max": {
        "en": "Row count check failed: expected at most {max} row(s), found {found}.",
        "fr": "Vérification du nombre de lignes échouée : attendu au plus {max} ligne(s), trouvé {found}.",
        "de": "Zeilenanzahlprüfung fehlgeschlagen: höchstens {max} Zeile(n) erwartet, {found} gefunden.",
        "it": "Controllo conteggio righe fallito: previste al massimo {max} riga/e, trovate {found}.",
        "es": "Verificación del número de filas fallida: se esperaban como máximo {max} fila(s), se encontraron {found}.",
        "pt": "Verificação de contagem de linhas falhou: esperadas no máximo {max} linha(s), encontradas {found}.",
        "ro": "Verificare număr rânduri eșuată: așteptate cel mult {max} rând(uri), găsite {found}.",
        "tr": "Satır sayısı kontrolü başarısız: en fazla {max} satır bekleniyordu, {found} bulundu.",
        "zh-Hans": "行数检查失败：预期最多 {max} 行，实际 {found} 行。",
        "zh-Hant": "行數檢查失敗：預期最多 {max} 行，實際 {found} 行。",
        "ja": "行数チェック失敗: 最大 {max} 行を期待しましたが、{found} 行でした。",
        "ko": "행 수 확인 실패: 최대 {max}행이 예상되었으나 {found}행이 발견됨.",
        "vi": "Kiểm tra số hàng thất bại: mong đợi nhiều nhất {max} hàng, tìm thấy {found}.",
        "ru": "Проверка количества строк не пройдена: ожидалось не более {max} строк(и), найдено {found}.",
        "cs": "Kontrola počtu řádků selhala: očekáváno nejvýše {max} řádků, nalezeno {found}.",
        "pl": "Sprawdzenie liczby wierszy nie powiodło się: oczekiwano co najwyżej {max} wiersz(y), znaleziono {found}.",
        "da": "Rækketællingskontrol mislykkedes: forventet højst {max} række(r), fandt {found}.",
        "sv": "Radräkningskontroll misslyckades: förväntade högst {max} rad(er), hittade {found}.",
        "nb": "Radtellingskontroll mislyktes: forventet høyst {max} rad(er), fant {found}.",
        "nl": "Rijtellingscontrole mislukt: maximaal {max} rij(en) verwacht, {found} gevonden.",
        "fi": "Rivimäärätarkistus epäonnistui: odotettiin enintään {max} riviä, löytyi {found}.",
        "is": "Raðfjöldaathugun mistókst: átti von á í mesta lagi {max} röð(um), fannst {found}.",
        "ar": "فشل فحص عدد الصفوف: متوقع على الأكثر {max} صف(وف)، وجد {found}.",
        "hi": "पंक्ति गणना जाँच विफल: अधिकतम {max} पंक्ति(यों) अपेक्षित, {found} पाई गईं।",
        "el": "Ο έλεγχος αριθμού γραμμών απέτυχε: αναμένονταν το πολύ {max} γραμμές, βρέθηκαν {found}.",
        "id": "Pemeriksaan jumlah baris gagal: diharapkan paling banyak {max} baris, ditemukan {found}.",
        "uk": "Перевірка кількості рядків не пройдена: очікувалося щонайбільше {max} рядків, знайдено {found}.",
        "bg": "Проверката на брой редове е неуспешна: очаквани най-много {max} реда, намерени {found}.",
        "hr": "Provjera broja redaka neuspješna: očekivano najviše {max} redak(a), pronađeno {found}.",
        "et": "Reakontroll ebaõnnestus: oodati kõige rohkem {max} rida, leiti {found}.",
        "hu": "Sorellenőrzés sikertelen: legfeljebb {max} sor volt várható, {found} található.",
        "ga": "Theip ar sheiceáil comhaireamh sraitheanna: ag súil le {max} sraith(eanna) ar a mhéid, aimsíodh {found}.",
        "lv": "Rindu skaita pārbaude neizdevās: gaidītas ne vairāk kā {max} rindas, atrastas {found}.",
        "lt": "Eilučių skaičiaus tikrinimas nepavyko: tikėtasi daugiausiai {max} eilučių, rasta {found}.",
        "mt": "Verifika tan-numru ta' ringiela falliet: mistenni l-aktar {max} ringiel(a), instab {found}.",
        "sk": "Kontrola počtu riadkov zlyhala: očakávalo sa najviac {max} riadkov, nájdených {found}.",
        "sl": "Preverjanje števila vrstic neuspešno: pričakovano največ {max} vrstic, najdenih {found}.",
        "he": "בדיקת מספר שורות נכשלה: צפויות לכל היותר {max} שורות, נמצאו {found}.",
        "th": "การตรวจสอบจำนวนแถวล้มเหลว: คาดหวังมากสุด {max} แถว พบ {found}",
        "fa": "بررسی تعداد ردیف ناموفق: حداکثر {max} ردیف انتظار می‌رفت، {found} یافت شد.",
    },
    "active_check_row_count_range": {
        "en": "Row count check failed: expected between {min} and {max} rows, found {found}.",
        "fr": "Vérification du nombre de lignes échouée : attendu entre {min} et {max} lignes, trouvé {found}.",
        "de": "Zeilenanzahlprüfung fehlgeschlagen: zwischen {min} und {max} Zeilen erwartet, {found} gefunden.",
        "it": "Controllo conteggio righe fallito: previste tra {min} e {max} righe, trovate {found}.",
        "es": "Verificación del número de filas fallida: se esperaban entre {min} y {max} filas, se encontraron {found}.",
        "pt": "Verificação de contagem de linhas falhou: esperadas entre {min} e {max} linhas, encontradas {found}.",
        "ro": "Verificare număr rânduri eșuată: așteptate între {min} și {max} rânduri, găsite {found}.",
        "tr": "Satır sayısı kontrolü başarısız: {min} ile {max} arası satır bekleniyordu, {found} bulundu.",
        "zh-Hans": "行数检查失败：预期 {min} 到 {max} 行，实际 {found} 行。",
        "zh-Hant": "行數檢查失敗：預期 {min} 到 {max} 行，實際 {found} 行。",
        "ja": "行数チェック失敗: {min} 行から {max} 行を期待しましたが、{found} 行でした。",
        "ko": "행 수 확인 실패: {min}~{max}행이 예상되었으나 {found}행이 발견됨.",
        "vi": "Kiểm tra số hàng thất bại: mong đợi từ {min} đến {max} hàng, tìm thấy {found}.",
        "ru": "Проверка количества строк не пройдена: ожидалось от {min} до {max} строк, найдено {found}.",
        "cs": "Kontrola počtu řádků selhala: očekáváno mezi {min} a {max} řádky, nalezeno {found}.",
        "pl": "Sprawdzenie liczby wierszy nie powiodło się: oczekiwano od {min} do {max} wierszy, znaleziono {found}.",
        "da": "Rækketællingskontrol mislykkedes: forventet mellem {min} og {max} rækker, fandt {found}.",
        "sv": "Radräkningskontroll misslyckades: förväntade mellan {min} och {max} rader, hittade {found}.",
        "nb": "Radtellingskontroll mislyktes: forventet mellom {min} og {max} rader, fant {found}.",
        "nl": "Rijtellingscontrole mislukt: tussen {min} en {max} rijen verwacht, {found} gevonden.",
        "fi": "Rivimäärätarkistus epäonnistui: odotettiin {min}–{max} riviä, löytyi {found}.",
        "is": "Raðfjöldaathugun mistókst: átti von á milli {min} og {max} raða, fannst {found}.",
        "ar": "فشل فحص عدد الصفوف: متوقع بين {min} و {max} صفوف، وجد {found}.",
        "hi": "पंक्ति गणना जाँच विफल: {min} से {max} पंक्तियों के बीच अपेक्षित, {found} पाई गईं।",
        "el": "Ο έλεγχος αριθμού γραμμών απέτυχε: αναμένονταν μεταξύ {min} και {max} γραμμών, βρέθηκαν {found}.",
        "id": "Pemeriksaan jumlah baris gagal: diharapkan antara {min} dan {max} baris, ditemukan {found}.",
        "uk": "Перевірка кількості рядків не пройдена: очікувалося від {min} до {max} рядків, знайдено {found}.",
        "bg": "Проверката на брой редове е неуспешна: очаквани между {min} и {max} реда, намерени {found}.",
        "hr": "Provjera broja redaka neuspješna: očekivano između {min} i {max} redaka, pronađeno {found}.",
        "et": "Reakontroll ebaõnnestus: oodati vahemikus {min} kuni {max} rida, leiti {found}.",
        "hu": "Sorellenőrzés sikertelen: {min} és {max} sor közötti érték volt várható, {found} található.",
        "ga": "Theip ar sheiceáil comhaireamh sraitheanna: ag súil le idir {min} agus {max} sraith, aimsíodh {found}.",
        "lv": "Rindu skaita pārbaude neizdevās: gaidītas starp {min} un {max} rindām, atrastas {found}.",
        "lt": "Eilučių skaičiaus tikrinimas nepavyko: tikėtasi nuo {min} iki {max} eilučių, rasta {found}.",
        "mt": "Verifika tan-numru ta' ringiela falliet: mistenni bejn {min} u {max} ringiela, instab {found}.",
        "sk": "Kontrola počtu riadkov zlyhala: očakávalo sa medzi {min} a {max} riadkami, nájdených {found}.",
        "sl": "Preverjanje števila vrstic neuspešno: pričakovano med {min} in {max} vrsticami, najdenih {found}.",
        "he": "בדיקת מספר שורות נכשלה: צפויות בין {min} ל-{max} שורות, נמצאו {found}.",
        "th": "การตรวจสอบจำนวนแถวล้มเหลว: คาดหวังระหว่าง {min} ถึง {max} แถว พบ {found}",
        "fa": "بررسی تعداد ردیف ناموفق: بین {min} تا {max} ردیف انتظار می‌رفت، {found} یافت شد.",
    },
    "active_check_table_empty": {
        "en": "Row count check failed: table is empty.",
        "fr": "Vérification du nombre de lignes échouée : le tableau est vide.",
        "de": "Zeilenanzahlprüfung fehlgeschlagen: Tabelle ist leer.",
        "it": "Controllo conteggio righe fallito: la tabella è vuota.",
        "es": "Verificación del número de filas fallida: la tabla está vacía.",
        "pt": "Verificação de contagem de linhas falhou: a tabela está vazia.",
        "ro": "Verificare număr rânduri eșuată: tabelul este gol.",
        "tr": "Satır sayısı kontrolü başarısız: tablo boş.",
        "zh-Hans": "行数检查失败：表为空。",
        "zh-Hant": "行數檢查失敗：表為空。",
        "ja": "行数チェック失敗: テーブルが空です。",
        "ko": "행 수 확인 실패: 테이블이 비어 있습니다.",
        "vi": "Kiểm tra số hàng thất bại: bảng trống.",
        "ru": "Проверка количества строк не пройдена: таблица пуста.",
        "cs": "Kontrola počtu řádků selhala: tabulka je prázdná.",
        "pl": "Sprawdzenie liczby wierszy nie powiodło się: tabela jest pusta.",
        "da": "Rækketællingskontrol mislykkedes: tabellen er tom.",
        "sv": "Radräkningskontroll misslyckades: tabellen är tom.",
        "nb": "Radtellingskontroll mislyktes: tabellen er tom.",
        "nl": "Rijtellingscontrole mislukt: tabel is leeg.",
        "fi": "Rivimäärätarkistus epäonnistui: taulukko on tyhjä.",
        "is": "Raðfjöldaathugun mistókst: taflan er tóm.",
        "ar": "فشل فحص عدد الصفوف: الجدول فارغ.",
        "hi": "पंक्ति गणना जाँच विफल: तालिका खाली है।",
        "el": "Ο έλεγχος αριθμού γραμμών απέτυχε: ο πίνακας είναι κενός.",
        "id": "Pemeriksaan jumlah baris gagal: tabel kosong.",
        "uk": "Перевірка кількості рядків не пройдена: таблиця порожня.",
        "bg": "Проверката на брой редове е неуспешна: таблицата е празна.",
        "hr": "Provjera broja redaka neuspješna: tablica je prazna.",
        "et": "Reakontroll ebaõnnestus: tabel on tühi.",
        "hu": "Sorellenőrzés sikertelen: a táblázat üres.",
        "ga": "Theip ar sheiceáil comhaireamh sraitheanna: tá an tábla folamh.",
        "lv": "Rindu skaita pārbaude neizdevās: tabula ir tukša.",
        "lt": "Eilučių skaičiaus tikrinimas nepavyko: lentelė tuščia.",
        "mt": "Verifika tan-numru ta' ringiela falliet: it-tabella hija vojta.",
        "sk": "Kontrola počtu riadkov zlyhala: tabuľka je prázdna.",
        "sl": "Preverjanje števila vrstic neuspešno: tabela je prazna.",
        "he": "בדיקת מספר שורות נכשלה: הטבלה ריקה.",
        "th": "การตรวจสอบจำนวนแถวล้มเหลว: ตารางว่างเปล่า",
        "fa": "بررسی تعداد ردیف ناموفق: جدول خالی است.",
    },
    "active_check_callable_returned_false": {
        "en": "the {fn_name} check returned {value}.",
        "fr": "la vérification {fn_name} a retourné {value}.",
        "de": "die Prüfung {fn_name} hat {value} zurückgegeben.",
        "it": "il controllo {fn_name} ha restituito {value}.",
        "es": "la verificación {fn_name} devolvió {value}.",
        "pt": "a verificação {fn_name} retornou {value}.",
        "ro": "verificarea {fn_name} a returnat {value}.",
        "tr": "{fn_name} kontrolü {value} döndürdü.",
        "zh-Hans": "{fn_name} 检查返回了 {value}。",
        "zh-Hant": "{fn_name} 檢查返回了 {value}。",
        "ja": "{fn_name} チェックが {value} を返しました。",
        "ko": "{fn_name} 확인이 {value}를 반환했습니다.",
        "vi": "kiểm tra {fn_name} trả về {value}.",
        "ru": "проверка {fn_name} вернула {value}.",
        "cs": "kontrola {fn_name} vrátila {value}.",
        "pl": "sprawdzenie {fn_name} zwróciło {value}.",
        "da": "kontrollen {fn_name} returnerede {value}.",
        "sv": "kontrollen {fn_name} returnerade {value}.",
        "nb": "kontrollen {fn_name} returnerte {value}.",
        "nl": "de controle {fn_name} gaf {value} terug.",
        "fi": "tarkistus {fn_name} palautti {value}.",
        "is": "athugunin {fn_name} skilaði {value}.",
        "ar": "أعاد الفحص {fn_name} القيمة {value}.",
        "hi": "{fn_name} जाँच ने {value} लौटाया।",
        "el": "ο έλεγχος {fn_name} επέστρεψε {value}.",
        "id": "pemeriksaan {fn_name} mengembalikan {value}.",
        "uk": "перевірка {fn_name} повернула {value}.",
        "bg": "проверката {fn_name} върна {value}.",
        "hr": "provjera {fn_name} vratila je {value}.",
        "et": "kontroll {fn_name} tagastas {value}.",
        "hu": "az {fn_name} ellenőrzés {value}-t adott vissza.",
        "ga": "d'fhill an seiceáil {fn_name} {value}.",
        "lv": "pārbaude {fn_name} atgrieza {value}.",
        "lt": "tikrinimas {fn_name} grąžino {value}.",
        "mt": "il-verifika {fn_name} irreturnat {value}.",
        "sk": "kontrola {fn_name} vrátila {value}.",
        "sl": "preverjanje {fn_name} je vrnilo {value}.",
        "he": "הבדיקה {fn_name} החזירה {value}.",
        "th": "การตรวจสอบ {fn_name} คืนค่า {value}",
        "fa": "بررسی {fn_name} مقدار {value} را برگرداند.",
    },
    "active_check_callable_raised_error": {
        "en": "the {fn_name} check raised an error: {exc_msg}",
        "fr": "la vérification {fn_name} a levé une erreur : {exc_msg}",
        "de": "die Prüfung {fn_name} hat einen Fehler ausgelöst: {exc_msg}",
        "it": "il controllo {fn_name} ha sollevato un errore: {exc_msg}",
        "es": "la verificación {fn_name} generó un error: {exc_msg}",
        "pt": "a verificação {fn_name} gerou um erro: {exc_msg}",
        "ro": "verificarea {fn_name} a generat o eroare: {exc_msg}",
        "tr": "{fn_name} kontrolü bir hata oluşturdu: {exc_msg}",
        "zh-Hans": "{fn_name} 检查引发了错误：{exc_msg}",
        "zh-Hant": "{fn_name} 檢查引發了錯誤：{exc_msg}",
        "ja": "{fn_name} チェックがエラーを発生させました: {exc_msg}",
        "ko": "{fn_name} 확인에서 오류가 발생했습니다: {exc_msg}",
        "vi": "kiểm tra {fn_name} đã gây ra lỗi: {exc_msg}",
        "ru": "проверка {fn_name} вызвала ошибку: {exc_msg}",
        "cs": "kontrola {fn_name} vyvolala chybu: {exc_msg}",
        "pl": "sprawdzenie {fn_name} zgłosiło błąd: {exc_msg}",
        "da": "kontrollen {fn_name} udløste en fejl: {exc_msg}",
        "sv": "kontrollen {fn_name} orsakade ett fel: {exc_msg}",
        "nb": "kontrollen {fn_name} utløste en feil: {exc_msg}",
        "nl": "de controle {fn_name} veroorzaakte een fout: {exc_msg}",
        "fi": "tarkistus {fn_name} aiheutti virheen: {exc_msg}",
        "is": "athugunin {fn_name} olli villu: {exc_msg}",
        "ar": "أثار الفحص {fn_name} خطأ: {exc_msg}",
        "hi": "{fn_name} जाँच ने एक त्रुटि उत्पन्न की: {exc_msg}",
        "el": "ο έλεγχος {fn_name} προκάλεσε σφάλμα: {exc_msg}",
        "id": "pemeriksaan {fn_name} menimbulkan kesalahan: {exc_msg}",
        "uk": "перевірка {fn_name} викликала помилку: {exc_msg}",
        "bg": "проверката {fn_name} предизвика грешка: {exc_msg}",
        "hr": "provjera {fn_name} izazvala je pogrešku: {exc_msg}",
        "et": "kontroll {fn_name} tekitas vea: {exc_msg}",
        "hu": "az {fn_name} ellenőrzés hibát okozott: {exc_msg}",
        "ga": "chruthaigh an seiceáil {fn_name} earráid: {exc_msg}",
        "lv": "pārbaude {fn_name} izraisīja kļūdu: {exc_msg}",
        "lt": "tikrinimas {fn_name} sukėlė klaidą: {exc_msg}",
        "mt": "il-verifika {fn_name} ikkawżat żball: {exc_msg}",
        "sk": "kontrola {fn_name} vyvolala chybu: {exc_msg}",
        "sl": "preverjanje {fn_name} je povzročilo napako: {exc_msg}",
        "he": "הבדיקה {fn_name} גרמה לשגיאה: {exc_msg}",
        "th": "การตรวจสอบ {fn_name} เกิดข้อผิดพลาด: {exc_msg}",
        "fa": "بررسی {fn_name} خطایی ایجاد کرد: {exc_msg}",
    },
    "step_set_inactive": {
        "en": "the {param} parameter was set to {value}.",
        "fr": "le paramètre {param} a été défini sur {value}.",
        "de": "der Parameter {param} wurde auf {value} gesetzt.",
        "it": "il parametro {param} è stato impostato su {value}.",
        "es": "el parámetro {param} se estableció en {value}.",
        "pt": "o parâmetro {param} foi definido como {value}.",
        "ro": "parametrul {param} a fost setat la {value}.",
        "tr": "{param} parametresi {value} olarak ayarlandı.",
        "zh-Hans": "{param} 参数设置为 {value}。",
        "zh-Hant": "{param} 參數設置為 {value}。",
        "ja": "{param} パラメータが {value} に設定されています。",
        "ko": "{param} 매개변수가 {value}(으)로 설정되었습니다.",
        "vi": "tham số {param} được đặt thành {value}.",
        "ru": "параметр {param} установлен в {value}.",
        "cs": "parametr {param} byl nastaven na {value}.",
        "pl": "parametr {param} został ustawiony na {value}.",
        "da": "parameteren {param} blev sat til {value}.",
        "sv": "parametern {param} sattes till {value}.",
        "nb": "parameteren {param} ble satt til {value}.",
        "nl": "de parameter {param} is ingesteld op {value}.",
        "fi": "parametri {param} asetettiin arvoon {value}.",
        "is": "færibreytan {param} var stillt á {value}.",
        "ar": "تم تعيين المعامل {param} إلى {value}.",
        "hi": "{param} पैरामीटर {value} पर सेट किया गया।",
        "el": "η παράμετρος {param} ορίστηκε σε {value}.",
        "id": "parameter {param} diatur ke {value}.",
        "uk": "параметр {param} встановлено в {value}.",
        "bg": "параметърът {param} е зададен на {value}.",
        "hr": "parametar {param} postavljen je na {value}.",
        "et": "parameeter {param} seati väärtusele {value}.",
        "hu": "a(z) {param} paraméter értéke {value} lett.",
        "ga": "socraíodh an paraiméadar {param} go {value}.",
        "lv": "parametrs {param} tika iestatīts uz {value}.",
        "lt": "parametras {param} nustatytas į {value}.",
        "mt": "il-parametru {param} ġie stabbilit għal {value}.",
        "sk": "parameter {param} bol nastavený na {value}.",
        "sl": "parameter {param} je bil nastavljen na {value}.",
        "he": "הפרמטר {param} הוגדר ל-{value}.",
        "th": "พารามิเตอร์ {param} ถูกตั้งค่าเป็น {value}",
        "fa": "پارامتر {param} روی {value} تنظیم شده است.",
    },
}
