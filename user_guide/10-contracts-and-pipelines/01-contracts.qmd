...
Now that you understand contracts, the next guide page covers **Pipelines**. They combine a source
contract, a transform, and a target contract into a complete boundary enforcement workflow. This
lets you validate data at both the *input* and *output* of your data transformations.
