...
validation plan from your existing data (great for getting started fast), or the
[AI Validation Copilot](advanced-validation/ai-validation-copilot.qmd) to refine an existing plan
