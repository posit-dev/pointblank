...
A column expression can be used to check column values. Just use [col_vals_expr()](../../reference/Validate.col_vals_expr.md#pointblank.Validate.col_vals_expr) for this.
...
<span style="text-decoration-style: solid; text-decoration-color: #ADD8E6; text-decoration-line: underline; text-underline-position: under; color: #333333; font-variant-numeric: tabular-nums; padding-left: 4px; margin-right: 5px; padding-right: 2px;">2026-04-13|17:02:37</span>
...
MzAuNjI4OTEyOCwxNi4yMzU1MTU3IDI4LjE5ODUxOTgsMTQuNjAyMTg2MyAyNS41MTMzMjcxLDE0LjYwMjE4NjMgTDIyLjE2ODI3MDEsMTQuNjAyMTg2MyBaIiBpZD0ibGFtYmRhIiBmaWxsPSIjMDAwMDAwIiBmaWxsLXJ1bGU9Im5vbnplcm8iIC8+CiAgICAgICAgPC9nPgogICAgPC9nPgo8L3N2Zz4=" />
