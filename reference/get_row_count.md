...
This table is a Polars DataFrame, but the [get_row_count()](get_row_count.md#pointblank.get_row_count) function works with any table supported by `pointblank`, including Pandas DataFrames and Ibis backend tables. Here's an example using a DuckDB table handled by Ibis:
