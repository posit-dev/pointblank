...
[missing](../../reference/cli/missing.md)  
...
[datasets](../../reference/cli/datasets.md)  
List available built-in datasets.

[requirements](../../reference/cli/requirements.md)  
Check installed dependencies and their availability.

[make-template](../../reference/cli/make_template.md)  
