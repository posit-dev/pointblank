...
<span style="text-decoration-style: solid; text-decoration-color: #ADD8E6; text-decoration-line: underline; text-underline-position: under; color: #333333; font-variant-numeric: tabular-nums; padding-left: 4px; margin-right: 5px; padding-right: 2px;">2026-07-22|23:22:09</span>
...
<span style="background-color: #FFF; color: #444; padding: 0.5em 0.5em; position: inherit; text-transform: uppercase; margin-left: 10px; margin-right: 5px; border: solid 1px #999999; font-variant-numeric: tabular-nums; border-radius: 0; padding: 2px 10px 2px 10px;">2026-07-22 23:22:09 UTC</span><span style="background-color: #FFF; color: #444; padding: 0.5em 0.5em; position: inherit; margin-right: 5px; border: solid 1px #999999; font-variant-numeric: tabular-nums; border-radius: 0; padding: 2px 10px 2px 10px;">< 1 s</span><span style="background-color: #FFF; color: #444; padding: 0.5em 0.5em; position: inherit; text-transform: uppercase; margin: 5px 1px 5px -1px; border: solid 1px #999999; font-variant-numeric: tabular-nums; border-radius: 0; padding: 2px 10px 2px 10px;">2026-07-22 23:22:09 UTC</span>
</div></td>
</tr>
</tfoot>
...
- `log_issue()` (the custom action) collects [metadata](SubmissionPackage.md#pointblank.SubmissionPackage.metadata) by calling [get_action_metadata()](get_action_metadata.md#pointblank.get_action_metadata)
- the [metadata](SubmissionPackage.md#pointblank.SubmissionPackage.metadata) is a dictionary that is used to craft the log message
...
[](%60~Have%60) a look at <a href="Actions.html#pointblank.Actions" class="gdls-link"><code>Actions</code></a> for more information on how to create custom  

[](%60~actions%60) for validation steps that exceed a set threshold value.
