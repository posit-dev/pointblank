...
```
    ...
    File ~/work/pointblank/pointblank/pointblank/validate.py:15913, in Validate.assert_passing(self)
      15909             ]
      15910             msg = "The following assertions failed:\n" + "\n".join(
      15911                 [f"- Step {i + 1}: {autobrief}" for i, autobrief in failed_steps]
      15912             )
    > 15913             raise AssertionError(msg)
