...
To obtain a dictionary representation of the summary, you can use the [to_dict()](Step.md#pointblank.Step.to_dict) method. To get a JSON representation of the summary, you can use the [to_json()](DataScan.to_json.md#pointblank.DataScan.to_json) method. To save the JSON text to a file, the [save_to_json()](DataScan.save_to_json.md#pointblank.DataScan.save_to_json) method could be used.
