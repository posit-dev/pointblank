...
`schema: Schema`  
A [Schema](Schema.md#pointblank.Schema) object that represents the expected schema of the table. This object is generated by the <a href="../reference/Schema.html#pointblank.Schema" class="gdls-link"><code>Schema</code></a> class.
...
Let's validate that the columns in the table match a predefined schema. A schema can be defined using the <a href="../reference/Schema.html#pointblank.Schema" class="gdls-link"><code>Schema</code></a> class.
