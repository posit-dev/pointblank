...
**Source:** [`CITATION.cff`](https://github.com/posit-dev/pointblank/blob/main/CITATION.cff)
...
@Manual{,
  ...
  year = {2026},
  note = {Python package version 0.25.0},
...
Iannone, R. (2026). *Pointblank: data validation toolkit for assessing and monitoring data quality.* (Version 0.25.0) \[Computer software\]. https://posit-dev.github.io/pointblank/
