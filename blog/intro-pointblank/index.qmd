...
[`interrogate()`](`Validate.interrogate`)
...
[`col_vals_lt()`](`Validate.col_vals_lt`)
...
[validation methods available in the library](../../reference/index.qmd#validation-steps).
...
[`get_step_report()`](`Validate.get_step_report`).
...
[`col_schema_match()`](`Validate.col_schema_match`)
validation method with a table schema prepared with the
[`Schema`](`Schema`) class allows us to verify
...
[**User Guide**](../../user-guide/index.qmd) written. We hope it provides
...
[gallery of examples](../../examples/index.qmd).
