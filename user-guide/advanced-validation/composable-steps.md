...
- **[Step](../../reference/Step.md#pointblank.Step)** (singular): a declarative data object used inside [Contract](../../reference/Contract.md#pointblank.Contract) definitions
- **[Steps](../../reference/Steps.md#pointblank.Steps)** (plural): a fluent builder that collects validation steps for use in any [Validate](../../reference/Validate.md#pointblank.Validate) plan

This page focuses on [Steps](../../reference/Steps.md#pointblank.Steps) and the `Validate.add_steps()` method, which together let you define portable step libraries and compose them into readable, top-to-bottom validation plans.
...
This works but reads *inside-out*. With more than two or three groups, the nesting becomes hard to follow. The step definitions are also coupled to whichever [Validate](../../reference/Validate.md#pointblank.Validate) object they happen to be called on.


# Building Step Libraries with [Steps](../../reference/Steps.md#pointblank.Steps)

The [Steps](../../reference/Steps.md#pointblank.Steps) class lets you record validation steps without binding them to data, thresholds, or any other [Validate](../../reference/Validate.md#pointblank.Validate) configuration. You use the same method names and parameters you already know from [Validate](../../reference/Validate.md#pointblank.Validate) ([col_vals_gt()](../../reference/Validate.col_vals_gt.md#pointblank.Validate.col_vals_gt), [col_vals_not_null()](../../reference/Validate.col_vals_not_null.md#pointblank.Validate.col_vals_not_null), [col_vals_regex()](../../reference/Validate.col_vals_regex.md#pointblank.Validate.col_vals_regex), etc.), but instead of running the checks, [Steps](../../reference/Steps.md#pointblank.Steps) stores them for later use.

The key benefit is **portability**: a [Steps](../../reference/Steps.md#pointblank.Steps) object can live in a shared Python module and be imported into any number of validation pipelines. The step definitions stay the same and only the data and configuration change at the point of use.
...
Each [Steps](../../reference/Steps.md#pointblank.Steps) object above is a self-contained recipe. You can inspect one to see what it contains:
...
In a Jupyter notebook or other rich-display environment, [Steps](../../reference/Steps.md#pointblank.Steps) renders as an HTML summary table.


# Composing Plans with `add_steps()`

The `add_steps()` method on [Validate](../../reference/Validate.md#pointblank.Validate) accepts one or more [Steps](../../reference/Steps.md#pointblank.Steps) objects and appends their recorded steps to the validation plan:
...
<span style="text-decoration-style: solid; text-decoration-color: #ADD8E6; text-decoration-line: underline; text-underline-position: under; color: #333333; font-variant-numeric: tabular-nums; padding-left: 4px; margin-right: 5px; padding-right: 2px;">Order quality</span>
...
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">total</td>
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">0</td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-left: 1px solid #D3D3D3"><img src="data:image/svg+xml;base64," /></td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-right: 1px solid #D3D3D3"><span style="color:#4CA64C;">✓</span></td>
<td class="gt_row gt_right" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px">3</td>
...
Because `add_steps()` returns the [Validate](../../reference/Validate.md#pointblank.Validate) object, it chains naturally and reads top-to-bottom.
...
<tr class="gt_heading">
<th colspan="14" class="gt_heading gt_subtitle gt_font_normal gt_bottom_border" style="text-align: left;"><div>
<span style="text-decoration-style: solid; text-decoration-color: #ADD8E6; text-decoration-line: underline; text-underline-position: under; color: #333333; font-variant-numeric: tabular-nums; padding-left: 4px; margin-right: 5px; padding-right: 2px;">Orders (extended)</span>
...
The `add_steps()` method accepts any number of positional arguments. Each can be a [Steps](../../reference/Steps.md#pointblank.Steps) object or even a [Validate](../../reference/Validate.md#pointblank.Validate) object (more on that [below](#importing-steps-from-a-validate-object)). All steps are appended in order:
...
One of the strengths of [Steps](../../reference/Steps.md#pointblank.Steps) is that step definitions are not locked to specific columns at definition time. When a step uses a column selector like [starts_with()](../../reference/starts_with.md#pointblank.starts_with) or a multi-column list, the columns are resolved when `add_steps()` applies them to the [Validate](../../reference/Validate.md#pointblank.Validate) plan, not when the [Steps](../../reference/Steps.md#pointblank.Steps) object is created. This means the same step library can validate tables with different schemas as long as they follow a common naming convention.
...
<tr class="gt_heading">
<th colspan="14" class="gt_heading gt_subtitle gt_font_normal gt_bottom_border" style="text-align: left;"><div>
<span style="text-decoration-style: solid; text-decoration-color: #ADD8E6; text-decoration-line: underline; text-underline-position: under; color: #333333; font-variant-numeric: tabular-nums; padding-left: 4px; margin-right: 5px; padding-right: 2px;">2026-09-25|21:48:43</span>
...
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">amt_price</td>
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">0</td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-left: 1px solid #D3D3D3"><img src="data:image/svg+xml;base64," /></td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-right: 1px solid #D3D3D3"><span style="color:#4CA64C;">✓</span></td>
<td class="gt_row gt_right" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px">3</td>
...
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">amt_tax</td>
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">0</td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-left: 1px solid #D3D3D3"><img src="data:image/svg+xml;base64," /></td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-right: 1px solid #D3D3D3"><span style="color:#4CA64C;">✓</span></td>
<td class="gt_row gt_right" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px">3</td>
...
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">amt_total</td>
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">0</td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-left: 1px solid #D3D3D3"><img src="data:image/svg+xml;base64," /></td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-right: 1px solid #D3D3D3"><span style="color:#4CA64C;">✓</span></td>
<td class="gt_row gt_right" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px">3</td>
...
The selector `starts_with("amt_")` is recorded verbatim in the [Steps](../../reference/Steps.md#pointblank.Steps) object and resolved when the steps are applied to the [Validate](../../reference/Validate.md#pointblank.Validate) plan. This means the same [Steps](../../reference/Steps.md#pointblank.Steps) object adapts to tables with different numbers of matching columns.


# Overrides in `add_steps()`

A shared step library represents a general-purpose set of checks, but individual pipelines often need to tweak how those checks are applied: tighter thresholds in production, certain checks disabled during development, or column names that differ across teams. Rather than creating a separate [Steps](../../reference/Steps.md#pointblank.Steps) object for every variation, `add_steps()` supports keyword arguments that modify the imported steps at the point of use, without changing the original [Steps](../../reference/Steps.md#pointblank.Steps) object.
...
<tr class="gt_heading">
<th colspan="14" class="gt_heading gt_subtitle gt_font_normal gt_bottom_border" style="text-align: left;"><div>
<span style="text-decoration-style: solid; text-decoration-color: #ADD8E6; text-decoration-line: underline; text-underline-position: under; color: #333333; font-variant-numeric: tabular-nums; padding-left: 4px; margin-right: 5px; padding-right: 2px;">2026-09-25|21:48:44</span>
...
<hr />
<strong>Notes</strong>
<p>Step 1 <span style="font-family: "IBM Plex Mono", monospace; font-size: smaller;">(local_thresholds)</span> Step-specific thresholds set with <span style="font-family: monospace;"><span style="color: #AAAAAA; font-weight: bold;">W</span>:0.01</span>.</p>
<p>Step 2 <span style="font-family: "IBM Plex Mono", monospace; font-size: smaller;">(local_thresholds)</span> Step-specific thresholds set with <span style="font-family: monospace;"><span style="color: #AAAAAA; font-weight: bold;">W</span>:0.01</span>.</p></td>
</tr>
</tfoot>
...
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">txn_amount</td>
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">0</td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-left: 1px solid #D3D3D3"><img src="data:image/svg+xml;base64," /></td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-right: 1px solid #D3D3D3"><span style="color:#4CA64C;">✓</span></td>
...
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">txn_amount</td>
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5; white-space: nowrap; text-overflow: ellipsis; overflow: hidden">100000</td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-left: 1px solid #D3D3D3"><img src="data:image/svg+xml;base64," /></td>
<td class="gt_row gt_center" style="height: 40px; background-color: #FCFCFC; border-right: 1px solid #D3D3D3"><span style="color:#4CA64C;">✓</span></td>
<td class="gt_row gt_right" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px">2</td>
<td class="gt_row gt_right" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px; border-left: 1px dashed #E5E5E5">2<br />
...
The remapping applies to the `columns=`, `column=`, and `columns_subset=` parameters. Column selectors (like [starts_with()](../../reference/starts_with.md#pointblank.starts_with)) pass through unchanged since they resolve dynamically against the target table.


# Importing Steps from a [Validate](../../reference/Validate.md#pointblank.Validate) Object

You don't always start from a [Steps](../../reference/Steps.md#pointblank.Steps) object. Sometimes you already have a [Validate](../../reference/Validate.md#pointblank.Validate) object with steps defined on it, perhaps loaded from a YAML file with `Validate.from_yaml()`, generated from a prompt with [Validate.from_prompt()](../../reference/Validate.from_prompt.md#pointblank.Validate.from_prompt), or simply built up in another part of your codebase. Rather than re-expressing those steps from scratch, you can pass the [Validate](../../reference/Validate.md#pointblank.Validate) object directly to `add_steps()` and its step definitions will be extracted and applied:
...
When a [Validate](../../reference/Validate.md#pointblank.Validate) object is passed as a step source, `add_steps()` extracts its step definitions and applies them. The data, thresholds, and metadata from the source [Validate](../../reference/Validate.md#pointblank.Validate) are *not* carried over, only the step recipes.

> **Note: Note**
>
> When a [Validate](../../reference/Validate.md#pointblank.Validate) object used multi-column lists (e.g., `columns=["id", "name"]`), those columns were already expanded into separate internal entries. The extracted steps will be individual single-column steps, not the original grouped call.


# [Steps](../../reference/Steps.md#pointblank.Steps) vs. [Step](../../reference/Step.md#pointblank.Step): When to Use Which

Pointblank has two similarly named classes that serve different purposes:

|  | [Step](../../reference/Step.md#pointblank.Step) | [Steps](../../reference/Steps.md#pointblank.Steps) |
|----|----|----|
...
| **API style** | Declarative (method name as string) | Fluent (same methods as [Validate](../../reference/Validate.md#pointblank.Validate)) |
| **Composition** | List concatenation: `steps_a + steps_b` | Chaining: `.add_steps(a).add_steps(b)` |

**Use [Step](../../reference/Step.md#pointblank.Step)** when you're defining data contracts. Contracts are declarative specifications that serialize to YAML and represent a fixed agreement about data quality.

**Use [Steps](../../reference/Steps.md#pointblank.Steps)** when you're building reusable validation logic for [Validate](../../reference/Validate.md#pointblank.Validate) workflows. The fluent API gives you autocomplete, type checking, and the same familiar syntax as writing steps directly on [Validate](../../reference/Validate.md#pointblank.Validate).

Both ultimately produce the same validation steps when applied to data. You can even initialize a [Steps](../../reference/Steps.md#pointblank.Steps) object from a list of [Step](../../reference/Step.md#pointblank.Step) objects:
...
<tr class="gt_heading">
<th colspan="14" class="gt_heading gt_subtitle gt_font_normal gt_bottom_border" style="text-align: left;"><div>
<span style="text-decoration-style: solid; text-decoration-color: #ADD8E6; text-decoration-line: underline; text-underline-position: under; color: #333333; font-variant-numeric: tabular-nums; padding-left: 4px; margin-right: 5px; padding-right: 2px;">Order validation (production)</span>
...
<td class="gt_row gt_right" style="height: 40px; color: #666666; font-size: 13px; font-weight: bold">3</td>
<td class="gt_row gt_left" style="height: 40px; color: black; font-family: IBM Plex Mono; font-size: 11px"><div style="margin: 0; padding: 0; display: inline-block; height: 30px; vertical-align: middle; width: 16%;">
" />
...
<hr />
<strong>Notes</strong>
<p>Step 1 <span style="font-family: "IBM Plex Mono", monospace; font-size: smaller;">(local_thresholds)</span> Step-specific thresholds set with <span style="font-family: monospace;"><span style="color: #AAAAAA; font-weight: bold;">W</span>:0.01|<span style="color: #EBBC14; font-weight: bold;">E</span>:0.05</span>.</p>
<p>Step 2 <span style="font-family: "IBM Plex Mono", monospace; font-size: smaller;">(local_thresholds)</span> Step-specific thresholds set with <span style="font-family: monospace;"><span style="color: #AAAAAA; font-weight: bold;">W</span>:0.01|<span style="color: #EBBC14; font-weight: bold;">E</span>:0.05</span>.</p>
<p>Step 3 <span style="font-family: "IBM Plex Mono", monospace; font-size: smaller;">(local_thresholds)</span> Step-specific thresholds set with <span style="font-family: monospace;"><span style="color: #AAAAAA; font-weight: bold;">W</span>:0.01|<span style="color: #EBBC14; font-weight: bold;">E</span>:0.05</span>.</p></td>
</tr>
</tfoot>
...
The <a href="../../reference/Steps.html#pointblank.Steps" class="gdls-link"><code>Steps</code></a> class and `Validate.add_steps()` method bring composability to Pointblank's validation workflows. By separating step *definitions* from step *execution*, you can build reusable rule libraries that stay portable across datasets, teams, and environments. The override parameters (`active=`, `thresholds=`, `exclude=`, and `columns_map=`) give each pipeline the flexibility to tailor shared checks without forking the underlying library.

For a complementary approach to reusable validation rules, see [Data Contracts](../../user-guide/contracts-and-pipelines/contracts.md), which define expectations as declarative, serializable specifications using the <a href="../../reference/Step.html#pointblank.Step" class="gdls-link"><code>Step</code></a> class. Both approaches produce the same validation steps at interrogation time. Choose [Steps](../../reference/Steps.md#pointblank.Steps) for fluent, code-first composition and [Contract](../../reference/Contract.md#pointblank.Contract) for declarative, YAML-friendly definitions.
