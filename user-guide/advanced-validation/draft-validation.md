...
The [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) class connects to various LLM providers to analyze your data's characteristics and generate a complete validation plan tailored to its structure and content.


# How [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) Works

When you use [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation), the process works through these steps:

1.  a statistical summary of your data is generated using the [DataScan](../../reference/DataScan.md#pointblank.DataScan) class
...
To use the [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) feature, you'll need:
...
This will install the `chatlas` package and other dependencies required for [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation).


## Supported LLM Providers

The [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) class supports multiple LLM providers:
...
The simplest way to use [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) is to provide your data and specify an LLM model. Let's try it out with the `global_sales` dataset.
...
Here's an example of a validation plan that might be generated by [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) for the `nycflights` dataset:
...
When using [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation), you specify the model in the format `"provider:model_name"`:
...
A key advantage of [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) is that your actual dataset is not sent to the LLM provider. Instead, only a summary is transmitted, which includes:
...
The validation plan generated by [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) is just a starting point. You'll typically want to:
...
The [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) class uses a carefully crafted prompt that instructs the LLM to:

1.  use the schema information to create a [Schema](../../reference/Schema.md#pointblank.Schema) object
2.  include <a href="../../reference/Validate.col_vals_not_null.html#pointblank.Validate.col_vals_not_null" class="gdls-link"><code>Validate.col_vals_not_null()</code></a> for columns with no missing values
...
## When to Use [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation)
...
Here's a recommended workflow incorporating [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation):

1.  generate an initial plan with [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation)
...
- Authentication Errors: ensure your API key is valid and correctly passed to [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation)
...
[DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) provides a powerful way to jumpstart your data validation process by leveraging LLMs to generate context-aware validation plans. By analyzing your data's structure and content, [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) can create comprehensive validation rules that would otherwise take significant time to develop manually.
...
By understanding how [DraftValidation](../../reference/DraftValidation.md#pointblank.DraftValidation) works and how to customize its output, you can significantly accelerate your data validation workflows and improve the quality of your data throughout your projects.
