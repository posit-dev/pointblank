...
<hr />
<strong>Notes</strong>
<p>Step 1 <span style="font-family: "IBM Plex Mono", monospace; font-size: smaller;">(freshness_details)</span> ✓ Most recent data: <code>2026-08-20 19:34:18</code> (age: <strong>1.0h</strong>, max allowed: 2d)</p></td>
</tr>
</tfoot>
